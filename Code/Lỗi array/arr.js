...
// NN là vì nó gán = [] nó là tạo 1 instance mới cho arr đó. Như kiểu gán địa chỉ trong C++ thì đây, arr1 gán địa chỉ sang NULL chứ arr2 vẫn trỏ vào địa chỉ cũ. Trừ khi thay đổi giá trị mới ảnh hưởng
...
// Thực chất nếu mảng chỉ có 1 reference thì gán = [] là xong thì mảng trong bộ nhớ k còn reference nào trỏ tới sẽ bị GC xóa
